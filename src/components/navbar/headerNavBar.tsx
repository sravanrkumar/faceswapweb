...
<nav className="p-2 w-full  border-b border-gray-900">
  ...
  <div className="flex md:order-2 space-x-3 ">
             <Link href="/" className="twitter"><Image src={"/assets/img/googleplay.png"} className="img-fluid" width={130} height={200} alt=""/></Link>
            <Link href="/" className="facebook"><Image src={"/assets/img/appstore.png"} className="img-fluid" width={120} height={200} alt=""/></Link>
